...
START_TEST(s21_final_test){
  ...
  // str = "x*cos(3 * x * 3.14) / 2 + cos(9 * x *3.14) / 4 + cos(27 * x * 3.14) / 8 + cos(81 * x * 3.14) / 16)";
  // res = s21_smart_calc(str);
  // ck_assert_double_eq(res,  * (cos(3 * x * 3.14) / 2 + cos(9 * x *3.14) / 4 + cos(27 * x * 3.14) / 8 + cos(81 * x * 3.14) / 16));
}
